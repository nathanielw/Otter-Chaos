...
export default class GameOver extends Phaser.State {
  ...
  create(game) {
    ...
    const style = { font: 'bold 60pt Amethysta', fill: '#ffb365', align: 'center', wordWrap: true, wordWrapWidth: game.world.width - (PADDING * 2) };
    const text = game.add.text(game.world.centerX, game.world.height  * 0.2, 'Game Over', style);
    text.lineSpacing = -20;
    text.anchor.set(0.5, 0);

    const smallStyle = { font: '30pt Amethysta', fill: '#6966aa', align: 'center', wordWrap: true, wordWrapWidth: game.world.width - (PADDING * 2) };
    ...
    const punStyle = { font: '20pt Amethysta', fill: '#fabf83', align: 'center', wordWrap: true, wordWrapWidth: game.world.width - (PADDING * 2) };
